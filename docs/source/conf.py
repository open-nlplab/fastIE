...
html_theme_options = {
    'logo_url':
    'https://github.com/open-nlplab/fastIE',
    'menu': [
        # A link
        {
            'name': 'GitHub',
            'url': 'https://github.com/open-nlplab/fastIE'
        },
        # A dropdown menu
        # {
        #     'name': 'Projects',
...
man_pages = [(master_doc, 'FastIE', 'FastIE Documentation', [author], 1)]
